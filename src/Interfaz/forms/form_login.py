...
from forms.interfaz import Interfaz
...
class App:
    def verificar(self):
        ...
        with open('forms/users.json', 'r') as file:
            users = json.load(file)['usuarios']

        if any(user['username'] == usu and user['password'] == password for user in users):
    ...
    def __init__(self):        
        ...
        logo =utl.leer_imagen("./imagenes/fondo.jpg", (200, 200))
        # frame_logo
